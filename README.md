...
Download the clotho-AQA dataset from https://zenodo.org/record/6473207#.YqQvfBpBxPY. Extract the zip file and place the audio files in `dataset/audio_files/` directory. Place the csv files in `metadata/` directory. 
# Extracting features
